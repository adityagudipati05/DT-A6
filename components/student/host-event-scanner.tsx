...
interface HostEventScannerProps {
  eventId: string
  onScanComplete?: () => void
}

export default function HostEventScanner({ eventId, onScanComplete }: HostEventScannerProps) {
  ...
  const scannerDivId = "qr_scanner_div"
              ...
              {records.map((r, i) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <div className="font-medium">{r.attendance}%</div>
